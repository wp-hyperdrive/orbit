...
Config::define('WP_SITEURL', Config::get('WP_HOME') . '/cms');
...
Config::define('WP_PLUGIN_URL', Config::get('WP_HOME') . Config::get('CONTENT_DIR') . '/plugins');
Config::define('PLUGINDIR', Config::get('WP_PLUGIN_DIR'));
...
$table_prefix = env('DB_PREFIX') ?: 'hf_';

Config::define('WP_USE_THEMES', true);
...
if (!defined('ABSPATH')) {
    Config::define('ABSPATH', "{$webroot_dir}/cms/");
}
